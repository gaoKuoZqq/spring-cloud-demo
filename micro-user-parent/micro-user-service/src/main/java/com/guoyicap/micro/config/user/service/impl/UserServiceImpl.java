...
public class UserServiceImpl implements UserService {
    ...
    public User selectByPrimaryKey(@PathVariable("id") Integer id) {
    	System.out.println("UserServiceImpl.selectByPrimaryKey()");
    ...
    public int deleteByPrimaryKey(@PathVariable("id") Integer id) {
    	System.out.println("UserServiceImpl.deleteByPrimaryKey()");
        return userDao.deleteByPrimaryKey(id);
    }
    @Override
    public int updateByPrimaryKey(@RequestBody User user) {
    	System.out.println("UserServiceImpl.updateByPrimaryKey()");
        return userDao.updateByPrimaryKey(user);
    }

	@Override
	public PageInfo<User> getPageList(@RequestBody User user) {
		System.out.println("UserServiceImpl.getPageList()");
